...
export const DOCS_NAV: { group: string; items: DocLink[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/docs/performance", label: "Performance tuning", keywords: "tok/s throughput resident layers pcie nvme cache batching context prefetch prefetch-depth auto-prefetch quantize-kv int8 kv" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/docs/config", label: "serve configuration", keywords: "serve flags options context-length resident-layers device chat-template prefetch-depth auto-prefetch quantize-kv prefix-cache" },
