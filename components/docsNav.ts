...
export const DOCS_NAV: { group: string; items: DocLink[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/docs/performance", label: "Performance tuning", keywords: "tok/s throughput resident layers pcie nvme cache batching context" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/docs/config", label: "serve configuration", keywords: "serve flags options context-length resident-layers device chat-template" },
      { href: "/docs/api", label: "HTTP API", keywords: "openai anthropic endpoints chat completions messages models sampling sse streaming auth" },
